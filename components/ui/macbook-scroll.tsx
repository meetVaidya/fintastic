...
import imageasset from "/public/images/background.png";
import logos from "/public/images/logo2.png"
import bgtemp from "/public/images/backgound.jpg"
...
export const MacbookScroll = ({
    ...
    const translate = useTransform(scrollYProgress, [0, 0.75, 1], [0, 700, 0]);
    const rotate = useTransform(scrollYProgress, [0.1, 0.12, 0.3, 0.6, 1], [-28, -28, 0, 0, -28]);
    const textTransform = useTransform(scrollYProgress, [0, 0.3], [0, 100]);
    const textOpacity = useTransform(scrollYProgress, [0, 0.2], [1, 0]);
    const Opacities = useTransform(scrollYProgress, [0, 0.99, 1], [1, 1, 0])
    return (
        <div
            ref={ref}
        ...
        >
            <motion.h2
                ...
                className="dark:text-white text-neutral-800 text-5xl font-bold mb-20 text-center font-[Orbitron]-mono"
            >
                {title || (
                    <span>
...
export const Lid = ({
    ...
    return (
        <div className="bakwas relative [perspective:800px] h-[800] w-[50]">
            <div
                style={{
                ...
                className="h-[12rem] w-[32rem] bg-[#010101] rounded-2xl p-82 relative"
            >
                <div
                    style={{
                        boxShadow: "0px 2px 0px 2px var(--neutral-900) inset",
                    }}
                    className="absolute h-[10rem] inset-0 bg-[#010101] rounded-lg flex items-center justify-center"
                >
            ...
            <motion.div
                ...
                className="h-96 w-[32rem] absolute inset-0 bg-[#010101] rounded-2xl p-2 flex justify-center items-center z-1"
            >
                <h1 className="absolute inset-0 z-50 rounded-lg bg-transparent text-center flex flex-col items-center justify-center text-6xl font-bold text-white tracking-tight font-mono">
                    FINTASTIC
                    <span className="mt-2 text-xl font-normal text-gray-400 tracking-wide font-mono">
                ...
                <Image
                    ...
                    alt="aceternity logo"
                    objectFit="cover"
                    className="absolute rounded-lg inset-0 h-full w-full z-100"
                />
